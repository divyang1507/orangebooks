      ...
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-5 pt-8 md:flex-row flex-col items-center w-[90%]">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div className="sm:flex-col lg:flex gap-4 justify-center">
              ...
              <button className="bg-orange-500 font-semibold text-white py-3 px-6 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
                Contact Us
              </button>
